<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Broadcast.aspx.cs" Inherits="Bla.Broadcast" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p>Nachricht wird an mehrere Patienten gesendet!</p>
            </div>
        </div>
                        ...
                        <form role="form" runat="server">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Betreff</label>
                                    <textarea id="lBetreff" class="form-control" rows="1" runat="server" ></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Inhalt</label>
                                    <textarea id="lInhalt" class="form-control" rows="2" runat="server"></textarea>
                                </div>
                                <div class="form-group">
                                    <div class="btn btn-default btn-file">
                                        <i class="fa fa-paperclip"></i> Datei anhägen
                                        <input type="file" name="attachment">
                                    </div>
                                </div>
                                    <asp:Button ID="btn_sub" runat="server" OnClick="btn_sub_Click" class="btn btn-warning float-right" Text="Sendeasasn"/>
                            </div>
                        </form>
                    </div>
                </div>
