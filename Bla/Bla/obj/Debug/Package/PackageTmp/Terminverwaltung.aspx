<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Terminverwaltung.aspx.cs" Inherits="Bla.Terminverwaltung" %>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p>(Terminvorschläge von Patienten an dem Arzt)</p>
            </div>
            <div class="col-md-4">
                <a href="terminerstellen.aspx" class="btn btn-primary"><strong>Termin erstellen</strong></a>
            </div>
        </div>
    </div>
    <br>
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Name des Patienten Patient</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-widget="remove" data-toggle="tooltip" title="Löschen">
    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Name des Patienten</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-widget="remove" data-toggle="tooltip" title="Löschen">
                        <i class="fa fa-times"></i></button>
                </div>
    ...
    <script src="Scripts/calendar script/jquery.slimscroll.min.js"></script>
    <script src="Scripts/calendar script/fastclick.js"></script>
    <script src="Scripts/sb-admin.min.js"></script>
    <script src="Scripts/calendar script/adminlte.min.js"></script>
    <script src="Scripts/calendar script/demo.js"></script>
</div>
</body>
