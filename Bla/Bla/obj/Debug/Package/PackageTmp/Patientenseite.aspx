<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patientenseite.aspx.cs" Inherits="Bla.Patientenseite" %>
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="row">
               ...
               <!--                 <asp:GridView ID="gv"  class="table-bordered" Width="100%" CellSpacing="0" runat="server">
                                    <Columns>
                                        <asp:BoundField DataField="id" HeaderText="ID" />
                                        <asp:BoundField DataField="therapy_week" HeaderText ="Therapiewoche" />
                                        <asp:BoundField DataField="create_date" HeaderText="Datum" />
                                        <asp:BoundField DataField="batchnumber" HeaderText ="Chargennummer" />
                                        <asp:BoundField DataField="quantity" HeaderText="Menge in ml" />
                                        <asp:BoundField DataField="speed" HeaderText ="Therapiewoche" />
                                        <asp:BoundField DataField="amount" HeaderText="ID" />
                                        <asp:BoundField DataField="place" HeaderText ="Therapiewoche" />
                                        <asp:TemplateField HeaderText ="Komplikationen">
                                            <ItemTemplate>
                                                    <asp:LinkButton ID="comBtn" runat="server" OnCommand="comBtn_Command" CommandArgument='<%# Eval("id") %>' Text='<%# Eval("complications") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Infetionen">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="infBtn" runat="server" OnCommand="infBtn_Command" CommandArgument='<%# Eval("id") %>' Text='<%# Eval("infections") %>' />
                                           </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns> 
                                </asp:GridView>-->
                                <asp:table runat="server" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <asp:TableHeaderRow TableSection="TableHeader">
                                        <asp:TableHeaderCell><h6>ID</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Therapiewoche</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Datum</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Chargennummer</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Menge in ml</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Anzahl Injektionsstellen</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Injekttionstelle</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Injektionsgeschwindigkeit ml/st</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Komplikationen</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Infektionen</h6></asp:TableHeaderCell>
                                    </asp:TableHeaderRow>
                                </asp:table>
                            </div>  
                        </div>
