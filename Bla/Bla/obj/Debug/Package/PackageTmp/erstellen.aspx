<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="erstellen.aspx.cs" Inherits="Bla.erstellen" %>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Aus-und Weiterbildung - Artikel hochladen</h1>
            </div>
        </div>
    </div>
                    ...
                    <form class="form-horizontal">
                        <div class="card-body">
                            <div class="form-group">
                                <label> <h6>Titel</h6></label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label> <h6>Inhalt</h6></label>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">Max. -- MB</p>
                            </div>
                            <button type="submit" class="btn btn-info">Vorschau</button>
                            <button type="submit" class="btn btn-warning float-right">hochladen</button>
                        </div>
