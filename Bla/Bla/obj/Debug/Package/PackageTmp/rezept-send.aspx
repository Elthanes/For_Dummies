<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rezept-send.aspx.cs" Inherits="Bla.rezept_send" %>
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Senden nur an eine Person möglich!</h3>
                        </div>
                        <h6>Rezept scan versenden, original Rezept kommt auf dem Postweg</h6>
                        <form role="form">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email Addresse / Benutzername</label>
                                ...
                                <img  src="photo/Kassenrezept.png" alt="Attachment"><img>
