<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="medicament.aspx.cs" Inherits="Bla.medicament" %>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Medikament-Datenbank</h1>
                <p>Inhalt: Zuordnung QR-Code, Barcode zu Medikamamentennamen, Charge, etc.</p>
                <p><strong>Es muss noch bearbeiten werden!!<strong></p>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <h6>Bitte geben Sie Name des Medikaments</h6>
                                <form class="form-inline my-2 my-lg-0 mr-lg-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" >
                                        <span class="input-group-append">
                                            <button class="btn btn-success" type="button"><strong>Suchen</strong></button>
                                         </span>
                                    </div>
                                </form>
                            </div>
