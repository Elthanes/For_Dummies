<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Komplikationen.aspx.cs" Inherits="Bla.Komplikationen" %>
                            ...
                            <div class="table-responsive">
                                <asp:table runat="server" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <asp:TableHeaderRow TableSection="TableHeader">
                                        <asp:TableHeaderCell><h6>Schmerz</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Fieber</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Schüttelfrost</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Rötung</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Juckreiz</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Kopfschmerzen</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Schwellung</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Müdigkeit</h6></asp:TableHeaderCell>
                                        <asp:TableHeaderCell><h6>Erbrechen</h6></asp:TableHeaderCell>
